...
export const loginUser = (data, responseCB, loadingCB) => {
    ...
    return axios
        ...
        .then(response => {
            ...
            if (responseCB) responseCB({ status: 200, ...response.data })
            return response.data
        })
        .catch(err => {
            if (loadingCB) loadingCB(false)
            if (responseCB) responseCB(err.response)
...
export const registerUser = (data, responseCB, loadingCB) => {
    ...
    return axios
        ...
        .catch(err => {
            if (loadingCB) loadingCB(false)
            if (responseCB) responseCB(err.response.data)
            return err.response.data
        })
}
...
export const createTweet = ({ data, token }, responseCB) => {
    ...
    return axios
        .post(url.CREATE_TWEET, data, { headers })
        .then(response => {
            if (responseCB) responseCB(response.data)
            return response.data
        })
